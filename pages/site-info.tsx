...
export const getStaticProps: any = getStaticPageInfo("site-info");
export const StieInfo: React.FC<any> = ({ pageInfo }) => {
    ...
    return <div className="siteInfo_in">
        ...
        <div className="w100 con03 con_block">
            <div className="w1200 box">
                <input id="tab-1" type="radio" name="radio-set" className="tab-selector-1" checked={true} />
                <label htmlFor="tab-1" className="tab-label-1"><b>인플루언서 등록</b></label>
                <input id="tab-2" type="radio" name="radio-set" className="tab-selector-2" />
                <label htmlFor="tab-2" className="tab-label-2"><b>활동방법</b></label>
                <input id="tab-3" type="radio" name="radio-set" className="tab-selector-3" />
                <label htmlFor="tab-3" className="tab-label-3"><b>실적확인</b></label>
                <input id="tab-4" type="radio" name="radio-set" className="tab-selector-4" />
                <label htmlFor="tab-4" className="tab-label-4"><b>정산방법</b></label>
