    ...
    return <div>
        ...
        <div className="krterms_box w1200">
            ...
            <div>
                ...
                <p>
                    이 약관은 주식회사 핑크로더(이하 “당사”라 함)와 여행자가 체결한 국내여행계약의 세부이행 및 준수사항을 정함을 목적으로 합니다.
                 </p>

                <h4 className="mt20">제2조(여행의 종류 및 정의)</h4>
                <ul className="txtul2">
                    <li>
                ...
                <h4 className="mt20">제3조(‘당사’와 여행자 의무)</h4>
                <ul className="txtul2">
                    <li>
                       1. ‘당사’는 여행자에게 안전하고 만족스러운 여행서비스를 제공하기 위하여 여행알선 및 안내․운송․숙박 등 여행계획의 수립 및 실행과정에서 맡은 바 임무를 충실히 수행하여야 합니다.
                ...
                <h4 className="mt20">제4조(계약의 구성)</h4>
                <ul className="txtul2">
                    <li>
                   ...
                   <li>
                       2. 여행계약서에는 ‘당사’의 상호, 소재지 및 관광진흥법 제9조에 따른 보증보험 등의 가입(또는 영업보증금의 예치 현황) 내용이 포함되어야 합니다.
                ...
                <h4 className="mt20">제5조(계약체결 거절)</h4>
                <ul className="txtul2">
                    <li>
                ...
                <h4 className="mt20">제6조(특약)</h4>
                <p>
                    ‘당사’와 여행자는 관련법규에 위반되지 않는 범위 내에서 서면(전자문서를 포함한다. 이하 같다)으로 특약을 맺을 수 있습니다.<br/>
                    이 경우 ‘당사’는 특약의 내용이 표준약관과 다르고 표준약관보다 우선 적용됨을 여행자에게 설명하고 별도의 확인을 받아야 합니다.

                 </p>

                
                <h4 className="mt20">제7조(계약서 등 교부 및 안전정보 제공)</h4>
                <p>
                    ‘당사’는 여행자와 여행계약을 체결한 경우 계약서와 여행약관, 여행일정표(또는 여행설명서)를 각 1부씩 여행자에게 교부하고, 여행목적지에 관한 안전정보를 제공하여야 합니다.<br />
                ...
                <h4 className="mt20">제8조(계약서 및 약관 등 교부 간주)</h4>
                ...
                <ul className="txtul">
                 ...
                 <p>
                   2. 여행자는 계약 체결시 계약금(여행요금 중 10%이하의 금액)을 ‘당사’에게 지급하여야 하며, 계약금은 여행요금 또는 손해배상액의 전부 또는 일부로 취급합니다.
                </p>
                 <p>
                ...
                <h4 className="mt20">제10조(여행조건의 변경요건 및 요금 등의 정산)</h4>
                <p>
               ...
               5. 제1항의 규정에 의하지 아니하고 여행조건이 변경되거나 제13조 내지 제15조의 규정에 의한 계약의 해제․해지로 인하여 손해배상액이 발생한 경우에는 여행출발 전 발생 분은 여행출발이전에, 여행 중 발생 분은 여행종료 후 10일 이내에 각각 정산(환급)하여야 합니다.
                 ...
                 <p>
                6. 여행자는 여행출발 후 자기의 사정으로 숙박, 식사, 관광 등 여행요금에 포함된 서비스를 제공받지 못한 경우 ‘당사’에게 그에 상응하는 요금의 환급을 청구할 수 없습니다. 다만, 여행이 중도에 종료된 경우에는 제15조에 준하여 처리합니다.
                ...
                <h4 className="mt20">제11조(여행자 지위의 양도)</h4>
                <p>
                  1. 여행자가 개인사정 등으로 여행자의 지위를 양도하기 위해서는 ‘당사’의 승낙을 받아야 합니다. 이때 ‘당사’는 여행자 또는 여행자의 지위를 양도받으려는 자가 양도로 발생하는 비용을 지급할 것을 조건으로 양도를 승낙할 수 있습니다.
                 <br /><br />
                ...
                <h4 className="mt20">제12조(‘당사’의 책임)</h4>
                <p>
                 1. 여행자는 여행에 하자가 있는 경우에 ‘당사’에게 하자의 시정 또는 대금의 감액을 청구할 수 있습니다. 다만, 그 시정에 지나치게 많은 비용이 들거나 그 밖에 시정을 합리적으로 기대할 수 없는 경우에는 시정을 청구할 수 없습니다.
                    ...
                    <br /><br />
                   4. ‘당사’는 여행 출발시부터 도착시까지 ‘당사’ 본인 또는 그 고용인, 현지여행사 또는 그 고용인 등(이하 ‘사용인’이라 함)이 제3조제1항에서 규정한 ‘당사’ 임무와 관련하여 여행자에게 고의 또는 과실로 손해를 가한 경우 책임을 집니다.
                    <br /><br /> 
                ...
                <h4 className="mt20">제13조(여행출발 전 계약해제)</h4>
                <p>
                ...
                <ul className="txtul">
                    <li>
                        1) ‘당사’가 해제할 수 있는 경우
                        <ul className="txtul3">
                            <li>ⓛ 제10조 제1항 제1호 및 제2호 사유의 경우</li>
                            <li>② 여행자가 다른 여행자에게 폐를 끼치거나 여행의 원활한 실시에 현저한 지장이 있다고 인정될 때</li>
                            <li>③ 질병 등 여행자의 신체에 이상이 발생하여 여행에의 참가가 불가능한 경우</li>
                            <li>④ 여행자가 계약서에 기재된 기일까지 여행요금을 지급하지 아니하는 경우</li>
                        </ul>
                     ...
                     <li>
                        ...
                        <ul className="txtul3">
                            <li>ⓛ 제10조 제1항 제1호 및 제2호 사유의 경우</li>
                            <li>② ‘당사’가 제18조에 따른 공제 또는 보증보험에 가입하지 아니 하였거나 영업보증금을 예치하지 않은 경우</li>
                            <li>
                                ③ 여행자의 3촌이내 친족이 사망한 경우
                                <ul>
                                    <li>가. 친족을 확인할 수 있는 서류(가족관계증명서 등)</li>
                                    <li>나. 진단서 또는 사체검안서(사망진단서)</li>
                                    <li>다. 그 밖에 필요한 자료</li>
                                </ul>
                            </li>
                            <li>
                ...
                <h4 className="mt20">제14조(최저행사인원 미 충족시 계약해제)</h4>
                <p>
                  1. ‘당사’는 최저행사인원이 충족되지 아니하여 여행계약을 해제하는 경우 당일여행의 경우 여행출발 24시간 이전까지, 1박2일 이상인 경우에는 여행출발 48시간 이전까지 여행자에게 통지하여야 합니다.
                </p>
                 <p>
                  2. ‘당사’가 여행참가자 수의 미달로 전항의 기일 내 통지를 하지 아니하고 계약을 해제하는 경우 이미 지급받은 계약금 환급 외에 계약금 100% 상당액을 여행자에게 배상하여야 합니다.
                </p>

                
                <h4 className="mt20">제15조(여행출발 후 계약해지)</h4>
                <ul className="txtul2">
                    <li>
                    ...
                    <li>
                       6. 제4항에 따라 계약이 해지된 경우 ‘당사’는 계약의 해지로 인하여 필요하게 된 조치를 할 의무를 지며, 계약상 귀환운송 의무가 있으면 여행자를 귀환운송하여야 합니다. 이 경우 귀환운송비용은 원칙적으로 ‘당사’가 부담하여야 하나, 상당한 이유가 있는 때에는 ‘당사’는 여행자에게 그 비용의 일부를 청구할 수 있습니다.
                    </li>
                </ul>

                
                <h4 className="mt20">제16조(여행의 시작과 종료)</h4>
                <p>
                    여행의 시작은 출발하는 시점부터 시작하며 여행일정이 종료하여 최종목적지에 도착함과 동시에 종료합니다. 다만, 계약 및 일정을 변경할 때에는 예외로 합니다.
                </p>

                <h4 className="mt20">제17조(설명의무)</h4>
                <p>
                ...
                <h4 className="mt20">제18조(보험가입 등)</h4>
                <p>
                   ‘당사’는 여행과 관련하여 여행자에게 손해가 발생 한 경우 여행자에게 보험금을 지급하기 위한 보험 또는 공제에 가입하거나 영업 보증금을 예치하여야 합니다.
                </p>


                <h4 className="mt20">제19(기타사항)</h4>
                <ul className="txtul2">
                    <li>
                       1. 이 계약에 명시되지 아니한 사항 또는 이 계약의 해석에 관하여 다툼이 있는 경우에는 ‘당사’와 여행자가 합의하여 결정하되, 합의가 이루어지지 아니한 경우에는 관계법령 및 일반관례에 따릅니다.
                ...
                <h4 className="mt20">  &lang; 소비자분쟁해결기준 &gt; </h4>
                <p>
                ...
                <h5 className="mt20">▶ 여행사의 귀책사유로 여행사가 취소하는 경우 </h5>
                <p className="mt10">
                ...
                <h5 className="mt20">▶ 여행자의 귀책사유로 여행자가 취소하는 경우</h5>
                 <p className="mt10">
                    <strong>&lang;당일여행인 경우&gt;</strong>
                ...
                <h5 className="mt20">▶ 여행사의 계약조건 위반으로 여행자가 여행계약을 해지하는 경우(여행전)</h5>
                 <p className="mt10">
                    <strong>&lang;당일여행인 경우&gt;</strong>
                ...
                <ul className="mt20">
                    <li>2) 여행사의 계약조건 위반으로 인한 피해(여행 후) - 여행자가 입은 손해배상</li>
                    <li>3) 여행사 또는 여행종사자의 고의 또는 과실로 인한 여행자의 피해 - 여행자가 입은 손해배상</li>
                    <li>4) 여행 중 위탁수하물의 분실, 도난, 기타사고로 인한 피해 - 여행자가 입은 손해배상</li>
                    <li>5) 여행사의 고의‧과실로 인해 여행일정의 지연 또는 운송 미완수- 여행자가 입은 손해배상</li>
                    <li>* 운송수단의 고장, 교통사고 등 운수업체의 고의 과실에 의한 경우도 포함함.</li>
                </ul>
